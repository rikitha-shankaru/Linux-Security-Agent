...
def main():
    ...
    print(f"{'='*70}")
    print(f"\n📊 Results:")
    print(f"  {'Tests Run:':<20} {report['tests_run']:>3}")
    print(f"  {'Failures:':<20} {report['failures']:>3}")
    print(f"  {'Errors:':<20} {report['errors']:>3}")
    print(f"  {'Success:':<20} {'✅ YES' if report['success'] else '❌ NO'}")
