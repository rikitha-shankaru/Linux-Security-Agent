...
# Upload this file to your VM and run: bash run_test_on_vm.sh
...
# Navigate to project
cd ~/Linux-Security-Agent || { echo "❌ Project directory not found. Cloning..."; git clone https://github.com/likitha-shankar/Linux-Security-Agent.git ~/Linux-Security-Agent; cd ~/Linux-Security-Agent; }
...
echo ""
echo "📊 View results:"
echo "  cat comprehensive_test_results.json"
echo ""
